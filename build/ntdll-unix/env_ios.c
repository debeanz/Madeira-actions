...
static RTL_USER_PROCESS_PARAMETERS *build_initial_params( void **module )
{
    ...
    if (NT_SUCCESS(status))
    {
        ...
        /* wow64 merge (125hz): the 2026-09-10 rejection of 32-bit main images that
         * stood here is gone. A 32-bit image now gets a guest window (ios_wow.h)
         * and build_wow64_parameters places its 32-bit PEB/params inside it. */
